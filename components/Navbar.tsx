...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className={`${styles.lnNavbar} ${isScrolled ? styles.lnNavbarScrolled : ""}`}
      >
        <div className={styles.lnNavbarInner}>
          ...
          <div className={styles.lnNavbarRight}>
            ...
            {/* <span className={styles.lnNavbarBrowse}>
              COMMUNITY <span className={styles.lnNavbarSoon}>SOON</span>
            </span> */}
            {/* <a className={styles.lnNavbarGithub} href="https://github.com/DavidHDev/react-bits" target="_blank" rel="noopener noreferrer">
  ...
  <>
    ...
    >
      ...
      <nav className={styles.mobileNav}>
        ...
        <Link href="/5min-city" className={styles.mobileNavLink} onClick={() => setMobileMenuOpen(false)}>
          5 Min City
        </Link>
