                ...
                <div className={containerClass}>
                    ...
                    <div className={`${styles.rightContent} ${isFinal ? styles.rightContentLarge : ''}`}>
                        ...
                        <p className={styles.description}>
                           <span className={styles.letterspace}>VALUE</span> <br/><span className={styles.letterspaSecon}>The rarest luxury<br/> isn't space. It's time.</span> <br/>
                           <RxComponentInstance className={styles.lettersIcon} />
