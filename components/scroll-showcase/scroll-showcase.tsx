    ...
    return (
        ...
        >
            <motion.div
                ...
                className="flex whitespace-nowrap text-[max(4rem,7.5vw)] font-black uppercase tracking-tighter leading-none text-[#DAA520]/40 drop-shadow-[0_0_12px_rgba(218,165,32,0.4)]"
            >
